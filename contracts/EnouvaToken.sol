...
contract EVAToken is ERC20Interface {
    ...
    function balanceOf(address tokenOwner) override public view returns (uint256) {
    ...
    function allowance(address tokenOwner, address spender) override public view returns (uint256) {
